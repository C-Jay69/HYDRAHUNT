      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="bg-[#111] border border-[#333] p-8 flex flex-col">
            ...
            <Button variant="ghost" fullWidth className="border border-white text-white hover:bg-white hover:text-black">START SCOUTING</Button>
          </div>
          ...
          <div className="bg-[#111] border-2 border-[#00FFFF] p-8 relative flex flex-col shadow-[0_0_30px_rgba(0,255,255,0.1)] z-10">
            ...
            <Button variant="primary" fullWidth className="bg-[#00FFFF] border-[#00FFFF] text-black font-black hover:bg-white hover:text-black">ACTIVATE HUNTER</Button>
          </div>
          ...
          <div className="bg-[#111] border border-[#BEF754] p-8 flex flex-col">
            ...
            <Button variant="ghost" fullWidth className="border border-[#BEF754] text-[#BEF754] hover:bg-[#BEF754] hover:text-black">UNLEASH HYDRA</Button>
          </div>
        </div>
      </div>
    </div>
